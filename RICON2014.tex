...
\section{The Industry View: Improving Cluster Metadata}
...
\frame{
\frametitle{The Industry View: Improving Cluster Metadata}
...
\framesubtitle{}
\begin{itemize}
	\item Joining academia and industry is powerful.
 	\item Riak's implementation has largely followed academic research, inadvertently...
	\pause
	\item ...even when the research was on sort of a different field...
	\pause
	\item ...and we have now begun to work together with academia.
\end{itemize}
}
...
\frame
{
	...
	\vspace{2cm}
	\begin{itemize}
		\item Jordan West $-$ @$\_$jrwest
		\item Jo{\~a}o Leit{\~a}o $-$ @jcaleitao
	\end{itemize}
}
